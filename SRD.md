...
## Rolls
When you "make a roll" you roll a [[#d12]] and add a bonus. The bonus is the sum of the [[#Stat]] used for the roll, the [[#Skill]] being used for the roll, and any [[#Expertise]] that the [[#Game Master]] agrees applies to the roll. Then you compare the total roll to the [[#Target Number]], if it roll is is equal or higher the roll succeeds. If the roll is lower than the [[#Target Number]], the roll fails.
...
#### Edge
When a character has Edge they roll the [[#d12]] twice and use the highest roll. If an NPC has Hindrance on a defense the attacking character has Edge on all rolls against that defense.

#### Hindrance
When a character has Hindrance they roll the [[#d12]] twice and use the lowest roll. If an NPC has Edge on an attack or skill the character has Hindrance when rolling their defense.
...
### Bennies
As a [[#Response]] a character can spend bennies to reroll a [[#d12]]. They can have a maximum of three Bennies as any time. At the beginning of a session the character starts with two. You gain bennies by expressing your character's [[#Drive]], [[#Bond]], or [[#Flaw]] in play. As well, [[#Game Master|Game Masters]] and [[#Player|Players]] (with [[#Game Master]] approval) can give bennies to another [[#Player]] for exceptional roleplay.  

### Rolling as a NPC
The [[#Game Master]] never rolls a [[#d12]], so when an NPC would need to roll add 5 to the applicable bonuses and that becomes the [[#Target Number]] to overcome that roll.
...
### Flaw
What undermines your character? Is it your drive taken to extreme? Is it an exception that will have you set aside your bond? Is it a weakness that your character will revert to when pressed? Acting on the character's Flaw is the easiest to gain [[#Bennies]]. As well, overcoming the flaw at great cost to your character is worth gaining [[#Bennies]]. 
...
## Features
Ancestry, Background, and Class Features are additional capabilities of the character. Features can be provide the character new [[#Actions in combat|Actions]], a new [[#Expertise]], or an exception that changes a rule for that character. 

## Ancestry
What fantastical bloodline do your character come from? What Ancestry [[#Features|Feature]] does that bloodline bestow? A full-blooded character gains both Ancestry [[#Features|Feature]]. A half-blooded character chooses one [[#Features|Feature]] from each parent's ancestry.
...
- **Small Stature** - Halfuns have [[#Hindrance]] when wielding weapons with the [[#Heavy]] tag and have a movement speed of 20 ft. Halfuns gain cover when standing behind a Medium sized or larger creature.
### Dwarf Blooded
...
- **Small Stature** - Gnomes have [[#Hindrance]] when wielding weapons with the [[#Heavy]] tag and have a movement speed of 20 ft. Gnomes gain cover when standing behind a Medium sized or larger creature.

## Culture
A character's culture provides a base of experience, as well it forms a broad [[#Expertise]]. Characters can use their culture as a Expertise in general if the situation calls for it. As well, each culture can bestow a specific [[#Abilities|Ability]] or [[#Expertise]]. 
...
## Skills
A character's [[#Class]] grants a character proficiency in a number of skills. They apply their [[#Proficiency Bonus]] when rolling any skills they are proficient in.
...
* Swimming, roll [[#Strength]]+[[#Athletics]] to move half the creature's speed while swimming.
...
### Weapon
This is a creature's prowess with weapons. If a weapon has multiple tags you can choose which [[#Stats|Stat]]+[[#Skills|Skill]] combo to use. When dealing damage with a weapon roll, add the [[#Stats|Stat]] bonus you used in the roll.
...
## Expertise
Expertises are additional training that your character has received. They are not tied to a specific [[#Skills|Skill]] or [[#Stats|Stat]]. You can apply a Expertise to rolls when they apply, adding the creature's proficiency to the roll. You can only add once Expertise to any one roll. The creature do not need to be proficient in a skill to use a Expertise.

- **Animal Handling** - Manipulating and controlling animals.
- **Arcana** - Experience with the arcane. Includes knowledge of Monstrosities, Elementals, and Outsiders.
- **History** - Experience with the history.
- **Intimidation** - Manipulating and controlling creatures through fear.
- **Medic** - Experience with the medicine.
- **Mounted Combat** - Mastery of controlling a mount in combat.
- **Nature** - Experience with the natural world. Includes knowledge of Beasts and Plants
- **Persuasion** - Manipulating creatures through force of personality.
- **Profession** - Mastery of a specific profession.
- **Religion** - Knowledge of religion. Includes knowledge about Undead and Outsiders
- **Unarmed Combat** - Mastery of dealing damage with your body.
- **Weapon** - Mastery of a specific weapon.

### Creating Expertises
Specialties are short descriptions of a realm of experience. They should not be too specific, but not as broad as the Expertises gained from [[#Culture]] or [[#Background]] or [[#Class]].
...
### React
[[#Dexterity]] and [[#Wits]] combine to make up a creature's React defense. This is used to avoid attacks or other hazards. This is also used when making initiative rolls.
...
| Hide | +1 | +2 | [[#light armor]] | 75 |
| Brigantine | +1 | +3 | [[#light armor]] | 125 |
...
| Crossbow | 1d10 | [[#Ammunition]], [[#Piercing]], [[#Martial]], [[#Mechanical]], [[#Ranged]] 120ft | 300 |
| Dagger | 1d4 | [[#Piercing]], [[#Fine]], [[#Finesse]], [[#Simple]], [[#Thrown]] 20ft| 20 |
| Dart | 1d4 | [[#Finesse]], [[#Piercing]], [[#Simple]], [[#Thrown]] 20ft| 5 |
...
| Handaxe | 1d6 | [[#Bladed]], [[#Fine]], [[#Simple]], [[#Thrown]] 20ft | 40 |
| Hand crossbow | 1d6 | [[#Ammunition]], [[#Piercing]], [[#Mechanical]], [[#Martial]], [[#Ranged]] 30ft | 100 |
| Halberd | 1d10 | [[#Bladed]], [[#Two-Handed]], [[#Heavy]], [[#Martial]], [[#Reach]] | 150 |
| Javelin | 1d6 | [[#Piercing]], [[#Simple]], [[#Thrown]] 60ft | 40 |
| Lance | 1d8 | [[#Piercing]], [[#Heavy]], [[#Martial]], [[#Mounted]], [[#Charging]] 1d8 | 100 |
| Long bow | 1d10 | [[#Ammunition]], Piecing, [[#Heavy]], [[#Martial]], [[#Two-Handed]], [[#Ranged]] 120ft | 200 |
...
| Sling | 1d6 | [[#Ammunition]], [[#Blunt]], [[#Simple]], [[#Ranged]] 80ft | 10 |
| Spear | 1d6 | [[#Piercing]], [[#Simple]], [[#Thrown]] 30ft, [[#Versatile]] 1d8 | 40 |
| Shortbow | 1d8 | [[#Ammunition]], [[#Piercing]], [[#Martial]], [[#Mounted]], [[#Ranged]] 80ft | 175 |
| Shortsword | 1d6 | [[#Finesse]], [[#Piercing]], [[#Martial]] | 200 |
| Trident | 1d6 | [[#Piercing]], [[#Thrown]] 30ft, [[#Versatile]] 1d8 | 80 |
...
#### Blunt
Blunt weapons rely on impact to do damage. The weilder may choose to do non-lethal damage when they hit. If the attack would drop the target to 0 [[#HP]] or below, they have 1 [[#HP]] and are [[#Unconscious]]. 
...
#### Martial
Requires [[#Weapon]] [[#Skill]] otherwise the wielder has a [[#Hindrance]] on attack, [[#Deflect]], and [[#React]] rolls.
...
#### Ranged
Can be fired at a single target up to the listed distance or three times the listed distance with a [[#Hindrance]].  Uses [[#Dexterity]] for rolls and bonus damage. If the attacker is adjacent to an enemy they have a [[#Hindrance]].
...
#### Slam
If the target is [[#Expose|Exposed]], on a hit the attacker can choose to push them 10ft away.
...
The party can disappear into a crowd with a shared challenge of spotting pursuers and openings with a [[#Wits]]+[[#Senses]] roll, lead the group from cover to cover with a [[#Dexterity]]+[[#Stealth]] roll or maneuver the crowd between the party and the pursuers with a [[#Dexterity]]+[[#Social]] roll, and to move quickly with a [[#Strength]]+[[#Athletics]] roll or move nimbly with a [[#Dexterity]]+[[#Athletics]] roll against the [[#React]] defense of their pursuers to shake them. As a [[#Perk]] the party can maneuver their pursuers to the place of their choosing. As a Complication, they run into a different group of enemies. On failure the party is tracked.

#### Runaway carriage
The party can stop of a runaway carriage with a shared challenge of taking control of the reins with a [[#Strength]]+[[#Athletics]] or recover the fallen reins [[#Dexterity]]+[[#Athletics]], maneuver the vehicle [[#Wits]]+[[#Pilot]], control the animals with a [[#Will]]+[[#Social]] with a [[#Target Number]] of 10. As [[#Perk]] they bring the carriage under control without stopping. As a Complication, one of the characters is thrown from the carriage. On failure the beasts don't stop until the carriage breaks.

#### Tracking a creature. 
The party can track a creature through the wilds with a shared challenge of reading trail signs of the target's passing with a [[#Wits]]+[[#Knowledge]], spot trail signs and movement in the brush with a [[#Wits]]+[[#Senses]], and move on the target without giving their position away with a [[#Dexterity]]+[[#Stealth]] or rushing to overtake them with a [[#Strength]]+[[#Athletics]] against a [[#Target Number]] of 4+Creature Tier, unless the target is moving stealthily then it is 6+ the creature's [[#Wits]]+[[#Stealth]], whichever is higher. As a [[#Perk]] they are able to catch the creature totally unaware. As a Complication, the target has lured the party into an ambush. On a failure the target slips their grasp.
...
### Round
Once each creature has gone and the round ends on initiative 0. Any Lair Acts or Environmental Events happen at this time. The total time elapsed is 6 seconds per round.

### Spaces
Spaces are an abstraction of space for the creatures to move through. They are either 5ft or 2 meters depending on your Game Master’s preference. Small and Medium-sized creatures take up a single Space. This both includes the area they fill but also the area needed to Act freely. Large creatures take up a two-by-two square of spaces. Huge creatures take up a three-by-three square of spaces. Gargantuan take up more spaces than can easily be represented on a battlefield. They 
are treated as an aspect of the terrain.

### Move Through
A creature can move through an allied creature's space. When moving through an enemy’s space, the area is considered Difficult Terrain. If a creature ends their turn within another creature's space they are Squeezing if they are allied, and Sharing a Space if they are enemies.

### Squeezing
Two allied creatures can squeeze into the same space. While they are squeezed together both creatures have a [[#Hindrance]] on Athletics, Weapon and Enigma rolls. As well, both creatures have a [[#Hindrance]] on React and Deflect defenses. Both creatures are [[#Expose|Exposed]].

### Share a Space
To opposing creatures can share a space. While they share a space they both have a Hindrance on Athletics, Weapon and Enigma rolls, except for Weapon rolls with weapons with the Fine tag. As well, both creatures have a Hindrance on React and Deflect defenses. Both creatures are Exposed.
...
##### Dodge
The creature have Edge on all [[#React]] rolls until their next turn.
...
##### Offhand Attack
If a creature has a weapon with the [[#Fine]] feature it can be used to make an Offhand Attack.
...
A creature makes a [[#Wits]]+[[#Senses]] roll to reveal hidden enemies.
...
#### Minor Act
Minor Acts are saying a few words, interacting with an object, drawing a weapon, dropping an item in the creature's hand, hand off an item to another willing creature, or other simple activity that doesn't require attention while distracted by combat.

#### Response
Creatures respond to another creature's action during that other creature's turn. A creature has a single response they can take between their turns unless otherwise specified.
...
### Critical Success
When a Player roll a 12 on the attack roll and the roll would hit the attack deals maximum damage. If the roll would not hit, the attack deals normal damage. 

### Critical Failure
When a Player rolls a 1 on a defense and the roll does not exceed the [[#Target Number]] their character takes maximum damage from the attack.

### Damage Resistance
If a creature has Damage Resistance they take half damage, rounded down, before applying the creature's [[#Soak]].

### Massive Damage
If a creature takes more than half of their [[#Maximum HP]] in a single attack they need to make a [[#Body]] roll against the total damage taken. Otherwise they drop to 0 [[#HP]] and begin [[#Dying]]. Creatures that take more than their [[#Maximum HP]] before applying soak drop to 0 [[#HP]] and begin [[#Dying]].
...
### Deafened
The character cannot hear and as such have a [[#Hindrance]] on [[#React]] rolls, [[#Social]] rolls, and [[#Senses]] rolls. [[#Stealth]] rolls have [[#Edge]] against deafened creatures. Deafened creatures are [[#Expose|Exposed]].

### Frightened
The creature cannot move towards the source of their fear. Frightened characters have a [[#Hindrance]] on all rolls while they can sense the source of their fear. Characters that inspire fear have Edge on rolls targeting their [[#Mind]] defense. Frightened creatures are [[#Expose|Exposed]].

### Grappled
The grappled creature's speed is reduced to 0 and attacks with weapons that don't have the [[#Fine]] tag have a [[#Hindrance]]. Grappled creatures are [[#Expose|Exposed]].
...
### Prone
Prone creatures can only crawl using two spaces of movement for every space traveled. Standing up spends half their movement speed. The prone creature has a [[#Hindrance]] on attack rolls. Melee attacks against the prone creature have Edge. Prone creatures are [[#Expose|Exposed]] to melee attacks.
...
### Scene Features
Every scene should have features in it that the characters and NPCs can interact with. The action should not take place in a featureless void. Chairs that can be thrown at a foe to Expose them, tables to flip and provide cover, campfires that can be kicked to spread fire, and chandeliers to swing from are features that the Game Master can populate the scene with. Interacting with features should generally be a Swift act or a Minor Act.

### Light and Visibility
Light and what it reveals is an important factor in the battlefield.

#### Cover
If a creature has at least half of their body behind something solid at opaque between them and their attacker they are considered under Cover. Obscuring effects, like dim light, fog, or dense foliage can also provide Cover from creatures more than 5ft away.  Character's have [[#Edge]] on [[#React]] defenses when behind cover, and have [[#Hindrance]] on attacks against creatures who have cover.
...
##### Darkness
Creatures in darkness are efectively [[#Invisible]].
...
#### Hazardous Terrain
Hazardous terrain is [[#Difficult Terrain]] that also deals damage when a character begins their turn within the area or and they move through the area.
...
##### Holding Breath
A creature makes a [[#Swift Act]] to hold their breath. They can hold it for as many rounds as a [[#Fortitude]]+[[#Focus]] roll. If a creature takes damage while holding their breath a [[#Fortitude]]+[[#Focus]] roll against the damage taken is required. If the creature fails they begin suffocating.

##### Suffocating
A creature can suffocate for a number of rounds equal to their [[#Fortitude]] bonus. After that they begin making [[#Stabilization Roll]]s at the beginning of their turn as long as it is in the water.
...
### Travel Time
Travel time is the distance that can be traveled on foot in a set time. This includes stopping for rest breaks and not pushing beyond Easy exertion. The time can be cut in a quarter by every creature making a Difficult Fortitude+Athletics roll. Failure of this roll decreases the creature’s Body by 1. At -4 the creature falls unconscious. Recovering this Body damage requires a day without traveling and lacking exertions like combat. 

Creatures with higher speed can cut the travel time by [[Something]].
...
## Advanced Classes
A character's class provides new [[#Features]] with each tier. If a [[#Features|Feature]] has the same name as one from a previous Tier, replace the old [[#Features|Feature]] with the new [[#Features|Feature]].
...
### Spellcasting Focus
Spellcasting focuses are specially crafted items that can be used to channel magical energies. Some focuses, like holy symbols, can be mounted on shields or weapons for double the normal cost to purchase one. 
...
### Spellcasting Roll
To cast a spell the caster rolls a d12 plus their [[#Spellcasting Bonus]]. For the spell to manifest the caster needs to roll over their current [[#Burn]]. As well, all spells unless otherwise stated in the spellcasting [[#Features|Feature]], require at least one free hand to make motions, a [[#Spellcasting Focus]] in the other, and be able to clearly speak the magic words. If any one of these conditions are not met the caster has a [[#Hindrance]] on their Spellcasting Roll. If two or more requirements are missing the spell fails.

### Burn
Burn is the current level of strain that the spellcaster must overcome to cast a spell. After a long rest, their Burn is set to a base value set by the spellcasting [[#Feature]]. If a spell has an effect on a failed roll, that roll still needs to be equal to or greater than the current Burn to successfully cast. If the spell successfully casts, add the spell’s tier to the caster's current Burn. Cantrips do not add to the caster's Burn, but must succeed to manifest.
...
### Cantrip
Cantrips can be cast at any time. Some cantrips scale as the caster advances in the tiers. If so it will be in the description.
...
### Casting time
Spells can be cast as an [[#Act]], a [[#Swift Act]], or a [[#Response]] to cast. If a spell is cast as a [[#Swift Act]] the caster cannot use an [[#Act]] to cast a spell, other than a [[#Cantrip]].

### Material Component
Some spells require a material component beyond using a [[#Spellcasting Focus]]. If one is listed it is consumed when the spell completes.
...
# Magic Items
Magic items are treasure that add [[#Features]] to a creature that wields, wears, or holds it.

## Creating an Item
Items shouldn't give bonuses, but grant the character new [[#Features]].
...
While wielding the shield the wielder have [[#Edge]] on initiative checks.
...
Creatures within 5ft of the target, including the target make a [[#React]] defense against the attack roll. They take 2d6 damage, half damage if the defense succeeded.
...
Melee attacks deal an additional 1d6 damage. As a [[#Swift Act]] the wielder can extinguish mundane or magical flames within 30ft. [[#Enigma]] rolls to cast a spell that involves fire targeting within 60ft of the wielder are rolled with a [[#Hindrance]].
...
The wearer's speed is always 30ft regardless of terrain unless reduced to 0ft. They can [[#Dash]] as a Swift Act.
...
Playing the pipes as an [[#Act]] to roll [[#Will]]+[[#Knowledge]] as well as any musical [[#Expertise]] against targets [[#Mind]] within 30ft that can hear them are [[#Frightened]] of the wielder for as long as the pipes play.
...
As a [[#Swift Act]] the wielder can command the rope to fasten itself to an object within 60ft.
...
#### Outsider
Creatures native to a plane other than the Material Plane.
