...
### Burn
Burn is the current level of strain that the spellcaster must overcome to cast a spell. After a long rest, their Burn is set to a base value set by the spellcasting [[#Features|Feature]]. If a spell has an effect on a failed roll, that roll still needs to be equal to or greater than the current Burn to successfully cast. If the spell successfully casts, add the spell’s tier to the caster's current Burn. As a [[#Complication]] add the spell's tier to the caster's current Burn. Cantrips do not add to the caster's Burn, but must be equal to or greater than the current Burn to manifest.
...
## Anatomy of a Spell
### Source
Each spellcasting [[#Archetype]] draws on a source of their power. 
...
#### Wall
The spell manifests 1 space wide, 2 spaces tall, and6 spaces long unless otherwise stated in the description.
...
A torch sized flame appears in the casters hand that can be used it to light fires. As a [[#Swift Act]] the caster can fling a flame up to6 spaces by rolling [[#Spellcasting Roll]] against the target's [[#Deflect]] that deals 1d6 damage. Flinging the flame does not end the spell. Increase the die for every [[#Tier]] the caster is beyond 1st.
...
Enchanted Items have a preternatural shine to them that distinguishes them from mundane item. The investigator rolls [[#Aptitude]]+[[#Craft]] plus the Arcana [[#Expertise]] against a [[#Target Number]] to identify the item and its [[#Feature]].
...
For consumable items the investigator can use the Alchemy Expertise and has an Edge on their identification roll.

### Identifying an Artifact
Determining their [[#Features]] required knowledge of what artifact you are identifying or making a Hard [[#Aptitude]]+[[#Knowledge]] roll with any [[#History]] [[#Expertise|Expertises]] to identify the artifact and learn its history. As a [[#Perk]] the investigator also learns how to activate one [[#Features|Feature]]. As a [[#Complication]] the artifact is misidentified and all subsequent rolls to investigate its aspects have a [[#Hinderance]] until a successful investigation happens.  

A creature that can see magic can spend a week to make an [[#Improbable]] [[#Aptitude]]+[[#Knowledge]] roll with the Arcana expertise to determine one [[#Features|Feature]] of the artifact. As a [[#Perk]] the investigator also learns how to activate the [[#Features|Feature]]. As a [[#Complication]] one aspect is misidentified and its activation deals damage or causes a [[#Complication]] every time it is activated. This continues until the investigator spends a week and makes a successful [[#Improbable]] [[#Aptitude]]+[[#Knowledge]] roll with any [[#History]] [[#Expertise|Expertises]].

## List of Magic Items
### Tier 1
- [[#Adamantium Armor]], Armor
- [[#Amulet Against Scrying]]
- [[#Amulet of Stabilization]], Attuned
- [[#Archmagi Wand]], Attuned
- [[#Bag of Holding]]
- [[#Blast Pike]], Weapon
- [[#Boots of the Stalker]]
- [[#Boots of Striding]]
- [[#Bracers of Archery]], Attuned
- [[#Bull Arrow]], Ammunition
- [[#Cloak of Protection]], Attuned
- [[#Cloak of the Wilds]], Attuned
- [[#Dust of Disappearance]], Consumable
- [[#Explosive Arrow]], Ammunition
- [[#Eyes of the Eagle]], Attuned
- [[#Featherlight Armor]], Armor
- [[#Firebrand]], Weapon, Attuned
- [[#Gloves of Missile Snaring]]
- [[#Goggles of Night]]
- [[#Helm of Understanding]], Attuned
- [[#Iceblade]], Weapon, Attuned
- [[#Lantern of Revealing]]
- [[#Leaping Shield]], Armor, Attuned
- [[#Lightning Caller]], Weapon, Attuned
- [[#Luck Stone]], Attuned
- [[#Mage Killer]], Ammunition
- [[#Muted Armor]], Armor
- [[#Pearl of Power]], Attuned
- [[#Pipes of Terror]]
- [[#Potion of Strength]], Consumable
- [[#Potion of Growth]], Consumable
- [[#Potion of Healing]], Consumable
- [[#Potion of Resistance]], Consumable
- [[#Rope of Climbing]]
- [[#Slippers of the Spider]], Attuned

### Tier 2
- [[#Arrow of Slaying]], Ammunition
- [[#Boots of Levitation]], Attuned
- [[#Boots of Speed]]
- [[#Cloak of the Spider]], Attuned
- [[#Courtier Armor]], Armor, Attuned
- [[#Eyes of the Mage]]
- [[#Flying Broom]]
- [[#Gauntlet of Strength]], Attuned
- [[#Potion of Farsight]], Consumable
- [[#Potion of Gaseous Form]], Consumable
- [[#Potion of Invisibility]], Consumable
- [[#Ring of Telekinesis]]
- [[#Slip Helm]]
- [[#Terror Mace]]
- [[#Wand of Fear]]
...
### Legacy Items
- [[#Diving Balestra]], Weapon
- [[#Ghost Warrior Armor]], Armor
